...
<div class="container">
    ...
    <div class="card">
        <form id="restaurantForm" method="POST"
              action="../../controllers/restaurantController.php?action=<?= $isEdit ? 'update' : 'create' ?>"
              novalidate>
            <?php if ($isEdit): ?>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" id="name" name="name" value="<?= $val('name') ?>" placeholder="e.g. Kacchi Bhai">
                    <div class="field-error" id="nameErr"></div>
                </div>
                <div class="form-group">
                    <label for="location">Location (City) *</label>
                    <input type="text" id="location" name="location" value="<?= $val('location') ?>" placeholder="e.g. Dhaka">
            ...
            <div class="form-group">
                ...
                <input type="text" id="area" name="area" value="<?= $val('area') ?>" placeholder="e.g. Gulshan, Banani">
            ...
            <div class="form-group">
                ...
                <textarea id="short_background" name="short_background"
                          placeholder="Brief history or story of the restaurant..."><?= $val('short_background') ?></textarea>
            ...
            <div class="form-group">
                ...
                <textarea id="goals" name="goals"
                          placeholder="What the restaurant aims to achieve..."><?= $val('goals') ?></textarea>
