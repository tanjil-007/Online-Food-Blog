...
<div class="container">
    ...
    <div class="card">
        <form id="menuForm" method="POST" enctype="multipart/form-data"
              action="../../controllers/menuItemController.php?action=<?= $isEdit ? 'update' : 'create' ?>"
              novalidate>
            ...
            <div class="form-group">
                ...
                <input type="text" id="name" name="name" value="<?= $val('name') ?>"
                       placeholder="e.g. Chicken Kacchi Biriyani">
            ...
            <div class="form-group">
                ...
                <textarea id="description" name="description"
                          placeholder="Describe the dish — ingredients, taste, serving size..."><?= $val('description') ?></textarea>
            ...
            <div class="form-group" style="max-width:250px;">
                ...
                <input type="number" id="price" name="price" step="0.01" min="0.01"
                       value="<?= $val('price') ?>" placeholder="0.00">
