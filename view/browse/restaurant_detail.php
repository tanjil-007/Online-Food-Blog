...
<div class="container">
    ...
    <div class="breadcrumb">
        <a href="restaurants.php">Restaurants</a> &rsaquo; <?= htmlspecialchars($restaurant['name']) ?>
    </div>
        ...
        <div style="display:grid; grid-template-columns:repeat(auto-fill, minmax(260px, 1fr)); gap:1.2rem;">
            ...
            <div class="restaurant-card">
                ...
                <div style="display:flex; justify-content:space-between; align-items:center;">
                    ...
                    <a href="menu_detail.php?id=<?= $item['id'] ?>" class="btn btn-secondary btn-sm">Details →</a>
                </div>
            </div>
            <?php endforeach; ?>
        </div>
