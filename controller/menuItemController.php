...
function handleImageUpload($fileKey) {
    ...
    $dest     = __DIR__ . '/../asset/uploads/menu/' . $filename;
    if (!move_uploaded_file($file['tmp_name'], $dest)) {
        return ['path' => null, 'error' => 'Could not save image. Check folder permissions.'];
    }
    return ['path' => 'asset/uploads/menu/' . $filename, 'error' => null];
}
...
if ($action === 'create' && $_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        if (addMenuItem($data, $upload['path'])) {
            ...
            header('Location: ../view/admin/menu_items.php?restaurant_id=' . $restaurant_id);
            exit;
        } else {
    ...
    header('Location: ../view/admin/menu_item_form.php?restaurant_id=' . $restaurant_id);
    exit;
}
...
if ($action === 'update' && $_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    header('Location: ../view/admin/menu_item_form.php?id=' . $id . '&restaurant_id=' . $restaurant_id);
    exit;
}
